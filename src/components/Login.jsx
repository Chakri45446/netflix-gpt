...
const Login = () => {
  ...
  photoURL: "https://c.ndtvimg.com/2025-06/9duj8ubo_rohit-sharma_625x300_26_June_25.jpg?im=FeatureCrop,algorithm=dnn,width=1200,height=738"
}).then(() => {
  // Profile updated!
  ...
  return (
    <> 
     ...
     <div>
        ...
        <form onSubmit={(e) =>e.preventDefault()} className='absolute bg-black w-115 h-180 p-12 my-30 m-auto right-0 left-0 text-white bg-black/80 '>
        <h1 className='text-3xl text-white-500 font-bold py-4 '>
            ...
            className='bg-red-500 w-full p-2 my-3 hover:cursor-pointer rounded-sm' onClick={handleButtonClick}>
                {isSignIn ? "Sign In" : "Sign Up"}
                </button>
            ...
            <div className="flex items-center text-gray-300 text-sm my-3">
                 <input 
                    ...
                    className="w-4 h-4 accent-red-600 cursor-pointer" 
                      />
                      <label  className="ml-2 cursor-pointer text-lg">
                          Remember me
                         </label>
         </div>
         <div className='flex'>
